  ...
  <div class="app-container">
    <el-row>
      <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="88px">
        <el-form-item label="快递公司w" prop="outerLogisticsId">
    ...
    <el-dialog title="共享电子面单给发货人" :visible.sync="shareOpen" width="600px" append-to-body>
      ...
      <el-form ref="form" :model="form2" :rules="rules2" label-width="120px">
        ...
        <el-form-item label="发货人" prop="shipperId">
          <el-select v-model="form2.shipperId" placeholder="请选择供应商" clearable >
            <el-option
...
import {listLogisticsStatus} from "@/api/shipping/logistics_library";
  ...
  methods: {
    ...
    updateWaybillAccount() {
      if(!this.queryParams.shopId){
        ...
        getShop(this.queryParams.shopId).then(response => {
          if (response.data) {
            this.shopType = response.data.type;
            this.waybillAccountPull()
          }else{
            this.$modal.msgError("请重新选择店铺")
          }
        })
      }
    },
